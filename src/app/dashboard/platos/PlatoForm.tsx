    ...
    <form action={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <p className="text-xs text-slate-500 mb-2">
          Español es obligatorio. Los demás son opcionales — si los dejas
          vacíos, la carta muestra el español para ese idioma.
        </p>
        ...
        {IDIOMAS.map((idioma) => (
          <div
            key={idioma.id}
            className={idioma.id === lang ? "space-y-3" : "hidden"}
          >
            <div>
      ...
      <div>
        ...
        <p className="text-xs text-slate-500 mb-2">
          Marca los que apliquen — obligatorio informar de ellos en hostelería
          en España.
        </p>
        <div className="flex flex-wrap gap-2">
          {ALERGENOS.map((e) => {
