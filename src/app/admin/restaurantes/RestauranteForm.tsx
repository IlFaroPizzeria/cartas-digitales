  ...
  return (
    <form action={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <input name="nombre" required defaultValue={restaurante?.nombre} className={inputClass} />
      </div>
      ...
      {restaurante && (
        <>
          ...
          <div>
            ...
            <input name="plan" defaultValue={restaurante.plan ?? ''} className={inputClass} />
          </div>
          ...
          <div>
            ...
            />
            <p className="mt-1 text-xs text-slate-500">
              Crea primero la cuenta en Supabase → Authentication → Users, y pega aquí su UID para
              enlazarla. Déjalo vacío para quitar el acceso.
            </p>
          </div>
        </>
      )}
